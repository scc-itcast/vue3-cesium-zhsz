import { getCurrentInstance, ref, nextTick, watch, onMounted, onBeforeUnmount } from 'vue';
import { clearSelection } from '../../utils/private/selection.mjs';
import { prevent, addEvt, cleanEvt } from '../../utils/private/event.mjs';
...
export { useAnchor as default, useAnchorProps };
