...
import BaiduMapMercatorTilingScheme from './BaiduMapTilingScheme.mjs';
...
export { BaiduMapImageryProvider as default };
//# sourceMappingURL=BaiduMapImageryProvider.mjs.map
