...
export declare const corridorOutlineGeometryProps: {
    cornerType: {
...
export declare type VcGeometryCorridorOutlineProps = {
    /**
...
export declare type VcGeometryCorridorOutlineRef = VcComponentPublicInstance<VcGeometryCorridorOutlineProps>;
