...
export declare const polylineVolumeGeometryProps: {
    cornerType: {
...
export declare type VcGeometryPolylineVolumeProps = {
    /**
...
export declare type VcGeometryPolylineVolumeRef = VcComponentPublicInstance<VcGeometryPolylineVolumeProps>;
