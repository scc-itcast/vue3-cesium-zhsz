...
var vue = require('vue');
var printView = require('./print-view.js');
...
const createPrintView = (options) => {
  ...
  const app = vue.createApp(printView["default"], printViewProps);
  app.mount(printWindow.document.getElementById("print"));
};

exports["default"] = createPrintView;
//# sourceMappingURL=createPrintView.js.map
