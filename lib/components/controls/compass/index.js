    ...
    return () => {
      if (canRender.value) {
        ...
        children.push(vue.h(index$2.VcBtn, {
          ...
          outerOptions.value.tooltip ? vue.h(index$2.VcTooltip, {
        ...
        children.push(vue.h(index$2.VcBtn, {
          ...
          innerOptions.value.tooltip ? vue.h(index$2.VcTooltip, {
        ...
        children.push(rotationMarkerStyle.value.opacity ? vue.h(index$2.VcBtn, {
