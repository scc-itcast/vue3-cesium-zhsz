...
var vue = require('vue');
var useSelectionIndicatior = require('./use-selection-indicatior.js');
...
var SelectionIndicator = vue.defineComponent({
  ...
  setup(props, ctx) {
    ...
    const useSelectionIndicatiorState = useSelectionIndicatior["default"](instance, props, $services);
    instance.createCesiumObject = async () => {
      const { viewer } = $services;
      const viewerElement = viewer._element;
      viewerElement.appendChild(vm.$(useSelectionIndicatiorState.rootRef));
      return vm.$(useSelectionIndicatiorState.rootRef);
    };
    ...
    instance.unmount = async () => {
      const { viewer } = $services;
      const viewerElement = viewer._element;
      viewerElement.contains(vm.$(useSelectionIndicatiorState.rootRef)) && viewerElement.removeChild(vm.$(useSelectionIndicatiorState.rootRef));
...
exports["default"] = SelectionIndicator;
