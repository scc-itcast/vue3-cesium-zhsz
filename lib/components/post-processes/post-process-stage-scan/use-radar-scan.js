...
var RadarScan = require('../../../shared/materials/shaders/RadarScan.js');
...
function useRadar($services) {
  const webgl = (options) => {
    ...
    return {
      shaderSource: RadarScan["default"],
      uniforms
    };
  };
  return {
...
exports["default"] = useRadar;
//# sourceMappingURL=use-radar-scan.js.map
