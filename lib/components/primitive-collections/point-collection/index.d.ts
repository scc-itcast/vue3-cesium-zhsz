...
export declare const pointCollectionProps: {
    points: {
...
export declare type VcCollectionPointProps = {
    /**
...
export declare type VcCollectionPointRef = VcComponentPublicInstance<VcCollectionPointProps>;
