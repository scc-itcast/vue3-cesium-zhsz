...
import type { VcComponentInternalInstance, VcDatasource, VcTerrainProvider, ViewerWidgetResizedEvent } from 'vue-cesium/es/utils/types';
declare const emits: {
    cesiumReady: (payload: typeof Cesium) => boolean;
    viewerWidgetResized: (payload: ViewerWidgetResizedEvent) => boolean;
    ...
    dataSourceAdded: (collection: Cesium.DataSourceCollection, dataSource: VcDatasource) => boolean;
    dataSourceMoved: (dataSource: VcDatasource, newIndex: number, oldIndex: number) => boolean;
    dataSourceRemoved: (collection: Cesium.DataSourceCollection, dataSource: VcDatasource) => boolean;
    ...
    terrainProviderChanged: (provider: VcTerrainProvider) => boolean;
...
declare const _default: import("vue").DefineComponent<{
    ...
    skeleton: {
        type: import("vue").PropType<boolean | import("vue-cesium/es/components/ui").VcSkeletonProps>;
        default: () => import("vue-cesium/es/components/ui").VcSkeletonProps;
    };
    touchHoldArg: {
        type: StringConstructor;
        default: string;
    ...
    onViewerWidgetResized?: (payload: ViewerWidgetResizedEvent) => any;
    ...
    onDataSourceAdded?: (collection: Cesium.DataSourceCollection, dataSource: VcDatasource) => any;
    onDataSourceMoved?: (dataSource: VcDatasource, newIndex: number, oldIndex: number) => any;
    onDataSourceRemoved?: (collection: Cesium.DataSourceCollection, dataSource: VcDatasource) => any;
    ...
    onTerrainProviderChanged?: (provider: VcTerrainProvider) => any;
    onMoveEnd?: () => any;
    onMoveStart?: () => any;
    ...
    skeleton: import("vue-cesium/es/components/ui").VcSkeletonProps;
    touchHoldArg: string;
}>;
export default _default;
export declare type VcViewerEmits = typeof emits;
