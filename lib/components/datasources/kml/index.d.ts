...
export declare const kmlDatasourceProps: {
    destroy: {
...
export declare type VcDatasourceKmlProps = {
    /**
     ...
     */
    onUnsupportedNodeEvent?: (datasource: Cesium.KmlDataSource, parentEntity: any, node: any, entityCollection: any, styleCollection: any, sourceResource: any, uriResolver: any) => void;
};
export declare type VcDatasourceKmlRef = VcComponentPublicInstance<VcDatasourceKmlProps>;
