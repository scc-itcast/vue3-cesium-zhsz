...
var index$8 = require('../../components/ui/index.js');
var index$7 = require('../../components/overlays/index.js');
var index$6 = require('../../components/primitive-collections/index.js');
...
var index$5 = require('../../components/post-processes/index.js');
...
function useDrawingSegment(props, ctx, cmpName, fs) {
    ...
    renderDatas.value.forEach((polylineSegment) => {
      ...
      if (cmpName === "VcDrawingRectangle" || cmpName === "VcMeasurementRectangle") {
        ...
        if (!lodashUnified.isUndefined(hpr) && defined(hpr)) {
          ...
          for (let i = 0; i < (props.edge || 4) - 1; i++) {
            const position = cesiumHelpers.getPolylineSegmentEndpoint(startPosition2, hpr[0] += Math.PI * 2 / (props.edge || 4), distance, viewer.scene.globe.ellipsoid);
        ...
        const viewPosition = cesiumHelpers.makeCartesian3(startPosition);
        ...
        labels.push({
          ...
          id: createGuid(),
          text: MeasureUnits["default"].distanceToString(distance, (_b = props.measureUnits) == null ? void 0 : _b.distanceUnits, props.locale, (_c = props.decimals) == null ? void 0 : _c.distance),
          ...labelOpts
        });
      }
      if (polyline.polygonPositions && polyline.polygonPositions.length) {
        ...
        for (let i = 0; i < positions.length - 1; i++) {
          ...
          if (s > 0 && positions.length > 2 && props.showDistanceLabel) {
            labels.push({
              text: MeasureUnits["default"].distanceToString(s, (_e = props.measureUnits) == null ? void 0 : _e.distanceUnits, props.locale, (_f = props.decimals) == null ? void 0 : _f.distance),
          ...
          if (positions.length > 2 && props.showAngleLabel) {
            if (i > 0 || props.loop) {
              ...
              angles.push(angle);
              labels.push({
                text: MeasureUnits["default"].angleToString(angle, (_g = props.measureUnits) == null ? void 0 : _g.angleUnits, props.locale, (_h = props.decimals) == null ? void 0 : _h.angle),
                position: point1,
                id: createGuid(),
                ...labelsOpts
              });
        ...
        labels.push({
          text: MeasureUnits["default"].areaToString(area, (_i = props.measureUnits) == null ? void 0 : _i.areaUnits, props.locale, (_j = props.decimals) == null ? void 0 : _j.area),
      ...
      if (props.showComponentLines) {
        ...
        labels.push({
          ...
          id: createGuid(),
          text: MeasureUnits["default"].distanceToString(polyline.xDistance || 0, (_k = props.measureUnits) == null ? void 0 : _k.distanceUnits, props.locale, (_l = props.decimals) == null ? void 0 : _l.distance),
          ...props.xLabelOpts
        });
        labels.push({
          position: polyline.yLabelPosition,
          id: createGuid(),
          text: MeasureUnits["default"].distanceToString(polyline.yDistance || 0, (_m = props.measureUnits) == null ? void 0 : _m.distanceUnits, props.locale, (_n = props.decimals) == null ? void 0 : _n.distance),
          ...props.yLabelOpts
        });
        labels.push({
          position: polyline.xAnglePosition,
          id: createGuid(),
          text: MeasureUnits["default"].angleToString(polyline.xAngle || 0, (_o = props.measureUnits) == null ? void 0 : _o.angleUnits, props.locale, (_p = props.decimals) == null ? void 0 : _p.angle),
          ...props.xAngleLabelOpts
        });
        labels.push({
          position: polyline.yAnglePosition,
          id: createGuid(),
          text: MeasureUnits["default"].angleToString(polyline.yAngle || 0, (_q = props.measureUnits) == null ? void 0 : _q.angleUnits, props.locale, (_r = props.decimals) == null ? void 0 : _r.angle),
  ...
  const handleMouseMove = (movement) => {
    ...
    if (cmpName === "VcMeasurementVertical") {
      ...
      if (!lodashUnified.isUndefined(heightPostion) && defined(heightPostion)) {
        const positions = polyline.positions;
  ...
  return () => {
    ...
    computedRenderDatas.value.forEach((polyline, index) => {
      ...
      if ((positions == null ? void 0 : positions.length) && (positions == null ? void 0 : positions.length) > 1) {
        children.push(vue.h(props.clampToGround ? index$2.VcPrimitiveGroundPolyline : index$2.VcPrimitive, {
        ...
        }, () => vue.h(index$3.VcGeometryInstance, {
          id: createGuid()
        ...
        if (cmpName === "VcAnalysisViewshed") {
          ...
          children.push(vue.h(index$5.VcPostProcessStage, {
            fragmentShader: fs,
            uniforms: {
          ...
          children.push(vue.h(index$2.VcPrimitive, {
            show: polyline.show && props.ellipsoidOpts.show || props.editable || polyline.drawStatus === DrawStatus["default"].Drawing,
            ...
            }, () => vue.h(index$4.VcGeometryEllipsoidOutline, {
              radii,
      ...
      if (polyline.polygonPositions && polyline.polygonPositions.length > 2) {
        ...
        children.push(vue.h(index$6.VcPolygon, {
          positions,
      ...
      children.push(vue.h(index$6.VcCollectionPoint, {
        enableMouseEvent: props.enableMouseEvent,
        show: polyline.show,
      ...
      cmpName.includes("VcMeasurement") && children.push(vue.h(index$6.VcCollectionLabel, {
        enableMouseEvent: props.enableMouseEvent,
        show: polyline.show,
    ...
    if (((_a = props.drawtip) == null ? void 0 : _a.show) && canShowDrawTip.value) {
      const { viewer } = $services;
      children.push(vue.h(index$7.VcOverlayHtml, {
    ...
    return vue.h(index$6.VcCollectionPrimitive, {
