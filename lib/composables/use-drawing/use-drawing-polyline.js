...
function useDrawingPolyline(props, ctx, cmpName) {
    ...
    renderDatas.value.forEach((polyline, index) => {
      ...
      if (cmpName === "VcAnalysisSightline") {
        ...
        observationPoint && destinationPoints.forEach((destinationPoint) => {
          ...
          const intersection = cesiumHelpers.getFirstIntersection(observationPoint, destinationPoint, $services.viewer, objectsToExclude);
        ...
        for (let i = 0; i < positions.length - 1; i++) {
          ...
          if (s > 0 && positions.length > 2 && props.showDistanceLabel) {
            labels.push({
              text: MeasureUnits["default"].distanceToString(s, (_b = props.measureUnits) == null ? void 0 : _b.distanceUnits, props.locale, (_c = props.decimals) == null ? void 0 : _c.distance),
          ...
          if (positions.length > 2 && props.showAngleLabel) {
            if (i > 0 || props.loop) {
              ...
              angles.push(angle);
              labels.push({
                text: MeasureUnits["default"].angleToString(angle, (_d = props.measureUnits) == null ? void 0 : _d.angleUnits, props.locale, (_e = props.decimals) == null ? void 0 : _e.angle),
                position: point1,
                id: createGuid(),
                ...polylineLabelsOpts
              });
        ...
        if (cmpName.includes("Area")) {
          labels.push({
            text: MeasureUnits["default"].areaToString(area, (_f = props.measureUnits) == null ? void 0 : _f.areaUnits, props.locale, (_g = props.decimals) == null ? void 0 : _g.area),
          ...
          labels.push({
            text: MeasureUnits["default"].distanceToString(distance, (_h = props.measureUnits) == null ? void 0 : _h.distanceUnits, props.locale, (_i = props.decimals) == null ? void 0 : _i.distance),
            position: positions[positions.length - 1],
            id: createGuid(),
            ...polylineLabelOpts
          });
  ...
  const handleMouseClick = (movement, options) => {
    ...
    if (options.button === 2 && drawStatus.value === DrawStatus["default"].Drawing) {
  ...
  return () => {
    ...
    computedRenderDatas.value.forEach((polyline, index) => {
      ...
      (_a2 = polyline.dashedLines) == null ? void 0 : _a2.forEach((dashedLine) => {
        children.push(vue.h(index$2.VcPrimitive, {
          show: polyline.show && props.dashLinePrimitiveOpts.show || props.editable || polyline.drawStatus === DrawStatus["default"].Drawing,
      ...
      children.push(vue.h(index$5.VcCollectionPoint, {
        ...
        points: polyline.points.map((point, subIndex) => {
          ...
          const show = (((_a3 = props.pointOpts) == null ? void 0 : _a3.show) || props.editable || polyline.drawStatus === DrawStatus["default"].Drawing) && (cmpName === "VcAnalysisSightline" && polyline.positions.length === 3 ? subIndex !== 1 : true) && !includes;
          if (cmpName === "VcAnalysisSightline") {
      ...
      cmpName.includes("VcMeasurement") && children.push(vue.h(index$5.VcCollectionLabel, {
        enableMouseEvent: props.enableMouseEvent,
        show: polyline.show,
      ...
      if (positions.length > 2 && (cmpName.includes("Polygon") || cmpName.includes("Area"))) {
        ...
        children.push(vue.h(index$5.VcPolygon, {
          positions,
    ...
    if (((_a = props.drawtip) == null ? void 0 : _a.show) && canShowDrawTip.value) {
      const { viewer } = $services;
      children.push(vue.h(index$6.VcOverlayHtml, {
    ...
    return vue.h(index$5.VcCollectionPrimitive, {
...
exports["default"] = useDrawingPolyline;
//# sourceMappingURL=use-drawing-polyline.js.map
